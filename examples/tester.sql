...
declare @database_name varchar(MAX) = 'AutoRegressTestDB'
declare @table_name varchar(MAX) = 'BostonHousingData'
declare @dependent_name varchar(MAX) = 'target'
...
declare @test_data_table_name varchar(MAX) = 'BostonHousingData'
declare @predictions_table_name varchar(MAX) = 'BostonHousingPredictions'

exec AutoRegressPredict @database_name, @model_table_name, @model_name, @test_data_table_name, @predictions_table_name

declare @view_predictions varchar(MAX) = 'select * from ' + @predictions_table_name + ' order by CRIM '
